...
elad_image = face_recognition.load_image_file("Known_images/elad.png")
elad_face_encoding = face_recognition.face_encodings(elad_image)[0]
...
# import numpy as np
#
# def process_image(input_image_path, known_face_encodings, known_face_names):
#     # Load the input image
#     input_image = cv2.imread(input_image_path)
#
#     # Resize image for faster face recognition processing
#     small_image = cv2.resize(input_image, (0, 0), fx=0.25, fy=0.25)
#
...
# binyamin_image = face_recognition.load_image_file("Known_images/binyamin.jpg")
#
# # Encode known faces
# binyamin_encoding = face_recognition.face_encodings(binyamin_image)[0]
#
# known_face_encodings = [binyamin_encoding,
#                         ]
# known_face_names = ["binyamin",
#                     ]
#
# # Process an example image
# input_image_path = "test_image.jpg"
# output_image = process_image(input_image_path, known_face_encodings, known_face_names)
#
# # Display the resulting image
